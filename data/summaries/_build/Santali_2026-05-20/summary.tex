...
{\justifying\normalsize\color{textblack}{\latinfont ei hafte rajan drought sthiti normal shreni ma bado kshetr rahe, jaha india er 84.7}\% {\latinfont area normal obostha anubhuti korche. drought dwara prabhavito mul kshetr, vishesh roop se D0}+ {\latinfont shreni, ei hafte 15.3}\% {\latinfont chilo. ei sankhya aage rajan samayara tulna ma komi dekha, karone drought kshetr hafte hafte 0.9 percentage points komi hoye, aage hafte 16.2}\% {\latinfont aetiye aage ek mahina aage 17.2}\% {\latinfont chilo. drought dwara sabse beshi prabhavito kshetr ma NCT of Delhi chilo jaha tar er 52.2}\% {\latinfont area drought ma, tarpor Manipur ma 42.3}\%, {\latinfont Mizoram ma 40.8}\%, {\latinfont Arunanchal Pradesh ma 40.3}\%, {\latinfont Jammu} \& {\latinfont Kashmir ma 38.9}\%, {\latinfont aetiye Meghalaya ma 34.1}\% {\latinfont chilo. vipor, West Bengal drought ma 0.0}\% {\latinfont report korlo, jaha Rajasthan, Gujarat, aetiye Telangana drought ma 1.0}\%, {\latinfont 2.1}\%, {\latinfont aetiye 3.4}\% {\latinfont report korlo}.\par}
\vspace{8pt}
