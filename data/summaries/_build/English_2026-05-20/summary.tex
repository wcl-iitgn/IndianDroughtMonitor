...
{\justifying\normalsize\color{textblack}The national drought situation this week is characterized by a majority of the area remaining in the Normal category, with a small portion experiencing drought conditions. The total area classified under D0 or worse was 15.3\% of India this week. This figure shows a contraction compared to the previous week, as the total drought area decreased by 0.9 percentage points week-on-week. The most affected regions by drought presence were NCT of Delhi, Manipur, Mizoram, Arunanchal Pradesh, Jammu \& Kashmir, and Meghalaya. Conversely, West Bengal reported 0.0\% of its area in drought, and Rajasthan, Gujarat, and Telangana reported 1.0\%, 2.1\%, and 3.4\% of their areas in drought, respectively.\par}
\vspace{8pt}
