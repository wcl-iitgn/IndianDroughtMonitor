...
{\justifying\normalsize\color{textblack}{\latinfont is hafte ka rashtriya sooksh samay darshata hai ki Bharat ka zyada hissa abhi bhi Normal shreni mein hai jisme 84.7}\% {\latinfont kshetra ko Normal classify kiya gaya hai is hafte D0 aur usse upar ke sthitiyon ka anubhav karne wala kul kshetra 15.3}\% {\latinfont tha yeh aankda pichhle avadhiyon ki tulna mein sooksh kshetra mein sankuchan ko darshata hai kyunki sooksh kshetra hafte dar hafte 0.9 pratishat bindu kam ho gaya jahan pichhle hafte mein 16.2}\% {\latinfont tha aur abhi 15.3}\% {\latinfont hai sooksh se sabse zyada prabhavit kshetra NCT of Delhi hai jiske 52.2}\% {\latinfont kshetra sooksh mein hai uske baad Manipur 42.3}\% {\latinfont Mizoram 40.8}\% {\latinfont Arunanchal Pradesh 40.3}\% {\latinfont Jammu} \& {\latinfont Kashmir 38.9}\% {\latinfont aur Meghalaya 34.1}\% {\latinfont hai iske vipreet West Bengal ne apne kshetra ka 0.0}\% {\latinfont sooksh mein report kiya jabki Rajasthan sabse kam prabhavit rajya tha jiske apne kshetra ka 1.0}\% {\latinfont sooksh mein tha}\par}
\vspace{8pt}
