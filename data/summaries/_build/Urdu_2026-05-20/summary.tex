...
{\justifying\normalsize\color{textblack}اس ہفتے کی قومی خشک سالی کی صورتحال میں ایک بڑا علاقہ نارمل زمرے میں باقی ہے، جس میں ہندوستان کا {\latinfont 84.7}\% حصہ نارمل حالات کا تجربہ کر رہا ہے۔ خشک سالی سے متاثر ہونے کا کل علاقہ، خاص طور پر ڈی{\latinfont 0}+ کلاس، اس ہفتے {\latinfont 15.3}\% تھا۔ یہ اعداد و شمار پچھلے ادوار کے مقابلے میں تنگی ظاہر کرتے ہیں، کیونکہ خشک سالی کا علاقہ ہفتہ بہ ہفتہ {\latinfont 0.9} فیصد پوائنٹس کم ہو گیا، جو پچھلے ہفتے {\latinfont 16.2}\% اور تقریباً ایک ماہ قبل {\latinfont 17.2}\% تھا۔ خشک سالی سے سب سے زیادہ متاثر ہونے والے علاقوں میں دہلی کا نکرت ({\latinfont NCT of Delhi)} شامل ہے جس کا {\latinfont 52.2}\% علاقہ خشک سالی کا شکار ہے، اس کے بعد منی پور {\latinfont 42.3}\%، مِزورام {\latinfont 40.8}\%، ارونچال پردیش {\latinfont 40.3}\%، جموں و کشمیر {\latinfont 38.9}\%، اور میگلایہ {\latinfont 34.1}\% ہیں۔ اس کے برعکس، مغربی بنگال نے خشک سالی میں {\latinfont 0.0}\% کی اطلاع دی، جبکہ راجستھان، گجرات اور تلنگانہ نے ترتیب وار {\latinfont 1.0}\%، {\latinfont 2.1}\%، اور {\latinfont 3.4}\% خشک سالی کی اطلاع دی۔\par}
\vspace{8pt}
