...
{\justifying\normalsize\color{textblack}اس हफ्ता کی قومی قحطی کی صورتحال میں ایک بڑا علاقہ نارمل زمرے میں باقی ہے، جس میں ہندوستان کا {\latinfont 84.7}\% حصہ نارمل حالات کا تجربہ کر رہا ہے۔ قحطی سے متاثرہ کل علاقہ، خاص طور پر ڈی{\latinfont 0}+ کلاس، اس ہفتے {\latinfont 15.3}\% تھا۔ یہ اعداد و شمار پچھلے ادوار کے مقابلے میں تنگی ظاہر کرتے ہیں، کیونکہ قحطی کا علاقہ ہفتہ بہ ہفتہ {\latinfont 0.9} فیصد پوائنٹس کم ہوا، جو پچھلے ہفتے {\latinfont 16.2}\% اور تقریباً ایک ماہ قبل {\latinfont 17.2}\% تھا۔ قحطی سے سب سے زیادہ متاثرہ علاقے میں دہلی کا نگرا ({\latinfont NCT of Delhi)} ہے جس کا {\latinfont 52.2}\% علاقہ قحطی میں ہے، جس کے بعد منی پور میں {\latinfont 42.3}\%، میزورام میں {\latinfont 40.8}\%، ارونچال پردیش میں {\latinfont 40.3}\%، جموں و کشمیر میں {\latinfont 38.9}\%، اور میگھالیہ میں {\latinfont 34.1}\% ہے۔ اس کے برعکس، مغربی بنگال نے قحطی میں {\latinfont 0.0}\% رپورٹ کیا، جبکہ راجستھان، گجرات اور تلنگانہ نے ترتیب وار {\latinfont 1.0}\%، {\latinfont 2.1}\%، اور {\latinfont 3.4}\% قحطی رپورٹ کیا۔\par}
\vspace{8pt}
