...
{\justifying\normalsize\color{textblack}هي اس هفتو جي قومي خشڪي صورتحال ۾ هڪ وڏو علائقو معمول جي ڪلاس ۾ رهي رهيو آهي، جتي پاڻي جي {\latinfont 84.7}\% حصي هندستان معمول جا حالتن تجربه ڪري رهيو آهي. خشڪي جو ڪو حصو، خاص طور تي {\latinfont D0}+ ڪلاس، هن هفتو ۾ {\latinfont 15.3}\% هو. هن عدد ۾ پيچيدڙن وقتن جي مقابلي ۾ گهٽتائي ڏيکاري آهي، جيئن خشڪي جو علائقو هفتو تائين {\latinfont 0.9} پيرسنٽ پوائنٽن سان گھٽجي ويو، جيڪو پچھلا هفتي ۾ {\latinfont 16.2}\% ۽ تقريبن هڪ مهين تائين {\latinfont 17.2}\% هو. خشڪي کان وڌيڪ متاثر ٿيندڙ علائقا ۾ دلهي جي نيوٽل ڪالپٽل {\latinfont 52.2}\% علائقو آهي، جنهن کان پوءِ مانيپور {\latinfont 42.3}\%، ميزورام {\latinfont 40.8}\%، عرنچال پردېش {\latinfont 40.3}\%، جامو ۽ ڪشمير {\latinfont 38.9}\%، ۽ ميغلائي {\latinfont 34.1}\% آهن. مخالف طور تي، ويست بنگال هن خشڪي ۾ {\latinfont 0.0}\% رپورٽ ڪئي، جڏهن ته راجستھان، گجرات ۽ تيلانجانا هن خشڪي ۾ بالترتیب {\latinfont 1.0}\%، {\latinfont 2.1}\% ۽ {\latinfont 3.4}\% رپورٽ ڪيون.\par}
\vspace{8pt}
