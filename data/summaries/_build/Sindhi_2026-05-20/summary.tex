...
{\justifying\normalsize\color{textblack}اس हفارن جي قومي خشڪي صورتحال ڏيکاري ٿي ته هندستان جي گھڻي حصي عام ڪلاس ۾ رهي آهي، جتي {\latinfont 84.7}\% علائقاء کي عام طور تي ڪلاس ڪيو ويو. هن हفارن ۾ خشڪي جي صورتحال، خاص طور تي {\latinfont D0} ۽ ان کان وڌيڪ، جو ڪو حصو {\latinfont 15.3}\% هو. هي عدد پيارن وقتن جي مقابلي ۾ خشڪي جي علائقي ۾ گھٽتائي کي ظاهر ڪري ٿي، جيتوڻيڪ مجموعي خشڪي جو علائقو هڪ هفتي کان ٻئي هفتن تائين {\latinfont 0.9} پيرسنٽ پوائنٽن گھٽجي ويو، جيڪو پچھلا هفتي جي {\latinfont 16.2}\% کان هن وقت {\latinfont 15.3}\% آهي. خشڪي کان وڌيڪ متاثر ٿيندڙ علائقا ۾ نجد ۽ {\latinfont 52.2}\% علائقو خشڪي ۾ آهي، جنهن کان پوءِ مانيپور ۾ {\latinfont 42.3}\%، ميزورام ۾ {\latinfont 40.8}\%، عرنچال پردېش ۾ {\latinfont 40.3}\%، جامو ۽ ڪشمير ۾ {\latinfont 38.9}\% ۽ ميغلائي ۾ {\latinfont 34.1}\% آهي. مخالف طور تي، ويست بنگال هن جي علائقي ۾ {\latinfont 0.0}\% خشڪي رپورٽ ڪئي، جڏهن ته راجستھان خشڪي کان سب تنهن {\latinfont 1.0}\% علائقو هو.\par}
\vspace{8pt}
