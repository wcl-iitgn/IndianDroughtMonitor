...
{\justifying\normalsize\color{textblack}ಈ ವಾರದ ರಾಷ್ಟ್ರೀಯ ಬರ ಪರಿಸ್ಥಿತಿಯು ಹೆಚ್ಚಿನ ಪ್ರದೇಶಗಳು ಸಾಮಾನ್ಯ ವರ್ಗದಲ್ಲಿ ಉಳಿದಿವೆ, ಸಣ್ಣ ಭಾಗವು ಬರ ಪರಿಸ್ಥಿತಿಗಳನ್ನು ಅನುಭವಿಸುತ್ತಿದೆ. ಈ ವಾರ ಡಿ{\latinfont 0}+ ಬರ ವರ್ಗದಲ್ಲಿ ಒಟ್ಟು ಪ್ರದೇಶವು {\latinfont 15.3}\% ಆಗಿದ್ದು, ಇದು ಹಿಂದಿನ ವಾರಕ್ಕಿಂತ {\latinfont 0.9} ಶೇಕಡಾ ಅಂಕಗಳ ಕುಸಿತವಾಗಿದೆ. ಬರ ವರ್ಗಗಳ ಒಟ್ಟು ವಿತರಣೆ ಸಾಮಾನ್ಯದಲ್ಲಿ {\latinfont 84.7}\%, ಡಿ{\latinfont 0}+ ನಲ್ಲಿ {\latinfont 15.3}\%, ಡಿ{\latinfont 1}+ ನಲ್ಲಿ {\latinfont 3.1}\%, ಡಿ{\latinfont 2}+ ನಲ್ಲಿ {\latinfont 0.2}\%, ಡಿ{\latinfont 3}+ ನಲ್ಲಿ {\latinfont 0.0}\%, ಮತ್ತು ಡಿ{\latinfont 4} ನಲ್ಲಿ {\latinfont 0.0}\% ಆಗಿದೆ. ಬರದಿಂದ ಹೆಚ್ಚು ಬಾಧಿತವಾದ ರಾಜ್ಯಗಳು ದೆಹಲಿ {\latinfont NCT 52.2}\%, ಮಣಿಪುರ {\latinfont 42.3}\%, ಮಿಜೋರಾಂ {\latinfont 40.8}\%, ಅರುಣಾಚಲ ಪ್ರದೇಶ {\latinfont 40.3}\%, ಜಮ್ಮು ಮತ್ತು ಕಾಶ್ಮೀರ {\latinfont 38.9}\%, ಮತ್ತು ಮೇಘಾಲಯ {\latinfont 34.1}\% ಆಗಿವೆ. ಇದಕ್ಕೆ ವ್ಯತಿರಿಕ್ತವಾಗಿ, ಪಶ್ಚಿಮ ಬಂಗಾಳವು {\latinfont 0.0}\% ಬರ ವರದಿ ಮಾಡಿದೆ, ಮತ್ತು ರಾಜಸ್ಥಾನ, ಗುಜರಾತ್, ಮತ್ತು ತೆಲಂಗಾಣವು ಕ್ರಮವಾಗಿ {\latinfont 1.0}\%, {\latinfont 2.1}\%, ಮತ್ತು {\latinfont 3.4}\% ಬರ ವರದಿ ಮಾಡಿವೆ.\par}
\vspace{8pt}
