...
{\justifying\normalsize\color{textblack}ఈ వారం జాతీయ కరువు పరిస్థితిలో ఎక్కువ ప్రాంతాలు సాధారణ తరగతిలో ఉన్నాయి, కొద్ది భాగం కరువు పరిస్థితులను అనుభవిస్తోంది. ఈ వారం డి{\latinfont 0}+ కరువు తరగతిలో మొత్తం ప్రాంతం {\latinfont 15.3}\%గా ఉంది, ఇది గత వారం కంటే {\latinfont 0.9} శాతం పాయింట్ల తగ్గుదలను సూచిస్తుంది. కరువు తరగతుల మొత్తం పంపిణీ సాధారణలో {\latinfont 84.7}\%, డి{\latinfont 0}+లో {\latinfont 15.3}\%, డి{\latinfont 1}+లో {\latinfont 3.1}\%, డి{\latinfont 2}+లో {\latinfont 0.2}\%, డి{\latinfont 3}+లో {\latinfont 0.0}\%, మరియు డి{\latinfont 4}లో {\latinfont 0.0}\%గా ఉంది. కరువుతో ఎక్కువగా ప్రభావితమైన రాష్ట్రాలు ఢిల్లీ {\latinfont NCT 52.2}\%, మణిపూర్ {\latinfont 42.3}\%, మిజోరామ్ {\latinfont 40.8}\%, అరుణాచల్ ప్రదేశ్ {\latinfont 40.3}\%, జమ్మూ కాశ్మీర్ {\latinfont 38.9}\%, మరియు మేఘాలయ {\latinfont 34.1}\%గా ఉన్నాయి. దీనికి విరుద్ధంగా, పశ్చిమ బెంగాల్ {\latinfont 0.0}\% కరువును నివేదించింది, మరియు రాజస్థాన్ {\latinfont 1.0}\%, గుజరాత్ {\latinfont 2.1}\%, మరియు తెలంగాణ {\latinfont 3.4}\% కరువును నివేదించింది.\par}
\vspace{8pt}
