...
{\justifying\normalsize\color{textblack}ఈ వారం జాతీయ కరువు పరిస్థితిలో ఎక్కువ ప్రాంతం సాధారణ వర్గంలో మిగిలి ఉంది, భారతదేశంలో {\latinfont 84.7} శాతం మంది సాధారణ పరిస్థితులను అనుభవిస్తున్నారు. ఈ వారం కరువుతో ప్రభావితమైన మొత్తం ప్రాంతం, ప్రత్యేకంగా డి{\latinfont 0}+ తరగతి, {\latinfont 15.3} శాతం. ఈ సంఖ్య గత కాలాలతో పోలిస్తే సంకోచాన్ని చూపింది, ఎందుకంటే కరువు ప్రాంతం వారానికి {\latinfont 0.9} శాతం పాయింట్లు తగ్గింది, గత వారం {\latinfont 16.2} శాతం మరియు సుమారు ఒక నెల ముందు {\latinfont 17.2} శాతం నుండి. కరువుతో ఎక్కువగా ప్రభావితమైన ప్రాంతాలలో ఢిల్లీ {\latinfont NCT 52.2} శాతం ప్రాంతంలో కరువుతో ఉంది, దాని తర్వాత మణిపూర్ {\latinfont 42.3} శాతం, మిజోరామ్ {\latinfont 40.8} శాతం, అరుణాచల్ ప్రదేశ్ {\latinfont 40.3} శాతం, జమ్మూ \& కాశ్మీర్ {\latinfont 38.9} శాతం మరియు మేఘాలయ {\latinfont 34.1} శాతం. దీనికి విరుద్ధంగా, పశ్చిమ బెంగాల్ కరువులో {\latinfont 0.0}\% నివేదించింది, అయితే రాజస్థాన్, గుజరాత్ మరియు తెలంగాణ వరుసగా {\latinfont 1.0}\%, {\latinfont 2.1}\% మరియు {\latinfont 3.4}\% కరువును నివేదించాయి.\par}
\vspace{8pt}
