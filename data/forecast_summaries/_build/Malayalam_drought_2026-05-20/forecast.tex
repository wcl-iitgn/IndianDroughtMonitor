...
{\justifying\normalsize\color{textblack}വരൾച്ചയുടെ പ്രവചനം ({\latinfont D0}–{\latinfont D4) 7} ദിവസത്തിൽ ഏകദേശം ഇന്ത്യയുടെ {\latinfont 14} ശതമാനം, {\latinfont 15} ദിവസത്തിൽ {\latinfont 10} ശതമാനം, {\latinfont 30} ദിവസത്തിൽ {\latinfont 6} ശതമാനം ഉണ്ടാകുമെന്ന് പ്രതീക്ഷിക്കുന്നു.\par}
\vspace{8pt}
