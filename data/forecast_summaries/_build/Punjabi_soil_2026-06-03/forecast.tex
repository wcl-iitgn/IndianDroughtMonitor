...
\newcommand{\idmrunhead}{%
  \begin{minipage}{\textwidth}
    {\small\bfseries\color{titleblue}{\latinfont Soil Moisture Forecast Outlook}}\hfill{\small\color{muted}{\latinfont Forecast initialized June 3, 2026}  ·  {\latinfont valid through Jul 03, 2026}}\\[2pt]
...
\\[3pt]{\small\color{muted}{\latinfont Forecast soil moisture for the 7-, 15- and 30-day horizons, initialized June 3, 2026}.}\par
\vspace{10pt}
...
\rowcolor{rowalt} {\latinfont North} & {\latinfont 0.20} & {\latinfont 0.20} & {\latinfont 0.20}\\
 {\latinfont Northwest} & {\latinfont 0.15} & {\latinfont 0.15} & {\latinfont 0.16}\\
\rowcolor{rowalt} {\latinfont Northeast} & {\latinfont 0.35} & {\latinfont 0.35} & {\latinfont 0.36}\\
 {\latinfont East} & {\latinfont 0.17} & {\latinfont 0.17} & {\latinfont 0.18}\\
\rowcolor{rowalt} {\latinfont Central} & {\latinfont 0.18} & {\latinfont 0.18} & {\latinfont 0.19}\\
 {\latinfont West} & {\latinfont 0.21} & {\latinfont 0.22} & {\latinfont 0.25}\\
\rowcolor{rowalt} {\latinfont South} & {\latinfont 0.23} & {\latinfont 0.23} & {\latinfont 0.25}\\
\end{tabular}
\end{document}
