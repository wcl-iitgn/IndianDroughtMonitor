...
{\justifying\normalsize\color{textblack}జాతీయంగా కరవాటాల సగటు {\latinfont 4.41} మి.మీ ({\latinfont 7} రోజులు) {\latinfont 15} మి.మీ ({\latinfont 15} రోజులు) మరియు {\latinfont 38} మి.మీ ({\latinfont 30} రోజులు).\par}
\vspace{8pt}
