...
{\justifying\normalsize\color{textblack}జాతీయంగా వర్షపు నీటి ప్రవాహం సగటున {\latinfont 4.41} మి.మీ ({\latinfont 7}-రోజులు) {\latinfont 15} మి.మీ ({\latinfont 15}-రోజులు) మరియు {\latinfont 38} మి.మీ ({\latinfont 30}-రోజులు) ఉంటుంది.\par}
\vspace{8pt}
