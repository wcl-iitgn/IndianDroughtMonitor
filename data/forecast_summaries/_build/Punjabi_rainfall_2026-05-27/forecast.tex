...
\newcommand{\idmrunhead}{%
  \begin{minipage}{\textwidth}
    {\small\bfseries\color{titleblue}{\latinfont Rainfall Forecast Outlook}}\hfill{\small\color{muted}{\latinfont Forecast initialized May 27, 2026}  ·  {\latinfont valid through Jun 26, 2026}}\\[2pt]
...
\\[3pt]{\small\color{muted}{\latinfont Forecast rainfall for the 7-, 15- and 30-day horizons, initialized May 27, 2026}.}\par
\vspace{10pt}
{\large\bfseries\color{titleblue}{\latinfont Outlook}}\\[2pt]
{\justifying\normalsize\color{textblack}ਰਾਸ਼ਟਰੀ ਪੱਧਰ 'ਤੇ ਮੌਨਸੂਨ ਦੀ ਉਮੀਦ ਅਨੁਸਾਰ {\latinfont 7} ਦਿਨਾਂ ਲਈ {\latinfont 16} ਮਿਲੀਮੀਟਰ {\latinfont 15} ਦਿਨਾਂ ਲਈ {\latinfont 38} ਮਿਲੀਮੀਟਰ ਅਤੇ {\latinfont 30} ਦਿਨਾਂ ਲਈ {\latinfont 131} ਮਿਲੀਮੀਟਰ ਵਰਖਾ ਹੋਵੇਗੀ।\par}
\vspace{8pt}
...
\rowcolor{rowalt} {\latinfont North} & {\latinfont 14} & {\latinfont 22} & {\latinfont 53}\\
 {\latinfont Northwest} & {\latinfont 13} & {\latinfont 15} & {\latinfont 44}\\
\rowcolor{rowalt} {\latinfont Northeast} & {\latinfont 32} & {\latinfont 132} & {\latinfont 416}\\
 {\latinfont East} & {\latinfont 27} & {\latinfont 35} & {\latinfont 107}\\
\rowcolor{rowalt} {\latinfont Central} & {\latinfont 11} & {\latinfont 17} & {\latinfont 81}\\
 {\latinfont West} & {\latinfont 4.27} & {\latinfont 19} & {\latinfont 183}\\
\rowcolor{rowalt} {\latinfont South} & {\latinfont 19} & {\latinfont 64} & {\latinfont 199}\\
\end{tabular}
\end{document}
