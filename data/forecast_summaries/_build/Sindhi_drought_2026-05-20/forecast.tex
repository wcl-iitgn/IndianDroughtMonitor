...
{\justifying\normalsize\color{textblack}دراه ({\latinfont D0-D4)} جو توقع آهي ته {\latinfont 7} ڏينهن ۾ پاڻي جي حوالي سان هندستان جي حوالي {\latinfont 14}\% کي ڍڪي وندو، {\latinfont 15} ڏينهن ۾ {\latinfont 10}\% ۽ {\latinfont 30} ڏينهن ۾ {\latinfont 6}\%\par}
\vspace{8pt}
