...
{\justifying\normalsize\color{textblack}دھوپ کا اندازو (ڈی{\latinfont 0}-ڈی{\latinfont 4) 7} ڏينهن ۾ پاڻي جي {\latinfont 14}\% حصي کي، {\latinfont 15} ڏينهن ۾ {\latinfont 10}\% ۽ {\latinfont 30} ڏينهن ۾ {\latinfont 6}\% حصي کي ڍڪيڻ جي توقع آهي.\par}
\vspace{8pt}
