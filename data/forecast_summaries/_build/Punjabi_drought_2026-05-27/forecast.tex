...
\newcommand{\idmrunhead}{%
  \begin{minipage}{\textwidth}
    {\small\bfseries\color{titleblue}{\latinfont Drought (CDI) Forecast Outlook}}\hfill{\small\color{muted}{\latinfont Forecast initialized May 27, 2026}  ·  {\latinfont valid through Jun 26, 2026}}\\[2pt]
...
\\[3pt]{\small\color{muted}{\latinfont Forecast drought (cdi) for the 7-, 15- and 30-day horizons, initialized May 27, 2026}.}\par
\vspace{10pt}
{\large\bfseries\color{titleblue}{\latinfont Outlook}}\\[2pt]
{\justifying\normalsize\color{textblack}ਅਗਲੇ {\latinfont 7} ਦਿਨਾਂ ਵਿੱਚ ਭਾਰਤ ਦੇ ਲਗਭਗ {\latinfont 19}\% ਖੇਤਰਾਂ ਵਿੱਚ ਬਿਜਲੀ ਦੀ ਕਮੀ ਦੀ ਭਵਿੱਖਬਾਣੀ ਹੈ {\latinfont 15} ਦਿਨਾਂ ਵਿੱਚ {\latinfont 18}\% ਅਤੇ {\latinfont 30} ਦਿਨਾਂ ਵਿੱਚ {\latinfont 28}\%.\par}
\vspace{8pt}
...
\rowcolor{rowalt} {\latinfont North} & {\latinfont 30} & {\latinfont 30} & {\latinfont 42}\\
 {\latinfont Northwest} & {\latinfont 5} & {\latinfont 4} & {\latinfont 8}\\
\rowcolor{rowalt} {\latinfont Northeast} & {\latinfont 37} & {\latinfont 36} & {\latinfont 40}\\
 {\latinfont East} & {\latinfont 11} & {\latinfont 22} & {\latinfont 48}\\
\rowcolor{rowalt} {\latinfont Central} & {\latinfont 11} & {\latinfont 11} & {\latinfont 44}\\
 {\latinfont West} & {\latinfont 42} & {\latinfont 37} & {\latinfont 30}\\
\rowcolor{rowalt} {\latinfont South} & {\latinfont 8} & {\latinfont 6} & {\latinfont 2}\\
\end{tabular}
\end{document}
