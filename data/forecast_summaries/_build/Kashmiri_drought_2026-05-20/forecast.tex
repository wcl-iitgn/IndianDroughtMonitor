...
{\justifying\normalsize\color{textblack}सूखे का पूर्वानुमान (डी{\latinfont 0}-डी{\latinfont 4) 7} दिनों में भारत के लगभग {\latinfont 14}\% को, {\latinfont 15} दिनों में {\latinfont 10}\% और {\latinfont 30} दिनों में {\latinfont 6}\% को कवर करने की उम्मीद है।\par}
\vspace{8pt}
