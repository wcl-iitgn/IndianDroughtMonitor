...
\newcommand{\idmrunhead}{%
  \begin{minipage}{\textwidth}
    {\small\bfseries\color{titleblue}{\latinfont Drought (CDI) Forecast Outlook}}\hfill{\small\color{muted}{\latinfont Forecast initialized June 3, 2026}  ·  {\latinfont valid through Jul 03, 2026}}\\[2pt]
...
\\[3pt]{\small\color{muted}{\latinfont Forecast drought (cdi) for the 7-, 15- and 30-day horizons, initialized June 3, 2026}.}\par
\vspace{10pt}
{\large\bfseries\color{titleblue}{\latinfont Outlook}}\\[2pt]
{\justifying\normalsize\color{textblack}ਅਗਲੇ {\latinfont 7} ਦਿਨਾਂ ਵਿੱਚ ਭਾਰਤ ਦੇ ਲਗਭਗ {\latinfont 18}\% ਖੇਤਰਾਂ ਵਿੱਚ ਲлоти ਦਾ ਅਨੁਮਾਨ ਹੈ {\latinfont 15} ਦਿਨਾਂ ਵਿੱਚ {\latinfont 25}\% ਅਤੇ {\latinfont 30} ਦਿਨਾਂ ਵਿੱਚ {\latinfont 27}\%.\par}
\vspace{8pt}
...
\rowcolor{rowalt} {\latinfont North} & {\latinfont 29} & {\latinfont 35} & {\latinfont 47}\\
 {\latinfont Northwest} & {\latinfont 4} & {\latinfont 7} & {\latinfont 14}\\
\rowcolor{rowalt} {\latinfont Northeast} & {\latinfont 33} & {\latinfont 40} & {\latinfont 33}\\
 {\latinfont East} & {\latinfont 21} & {\latinfont 42} & {\latinfont 61}\\
\rowcolor{rowalt} {\latinfont Central} & {\latinfont 11} & {\latinfont 32} & {\latinfont 36}\\
 {\latinfont West} & {\latinfont 38} & {\latinfont 37} & {\latinfont 8}\\
\rowcolor{rowalt} {\latinfont South} & {\latinfont 7} & {\latinfont 6} & {\latinfont 0}\\
\end{tabular}
\end{document}
