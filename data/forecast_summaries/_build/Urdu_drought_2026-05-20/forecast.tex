...
{\justifying\normalsize\color{textblack}خشک موسم کی پیش گوئی (ڈی{\latinfont 0} سے ڈی{\latinfont 4)} کے مطابق {\latinfont 7} دنوں میں ہندوستان کے تقریباً {\latinfont 14} فیصد حصے، {\latinfont 15} دنوں میں {\latinfont 10} فیصد اور {\latinfont 30} دنوں میں {\latinfont 6} فیصد کا احاطہ کرنے کی توقع ہے۔\par}
\vspace{8pt}
