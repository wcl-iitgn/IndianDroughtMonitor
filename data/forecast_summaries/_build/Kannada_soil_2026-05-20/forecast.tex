...
{\justifying\normalsize\color{textblack}ರಾಷ್ಟ್ರೀಯವಾಗಿ ಮಣ್ಣಿನ ತೇವಾಂಶ ಸರಾಸರಿಗಳು {\latinfont 0.20} ವಿ/ವಿ ({\latinfont 7} ದಿನಗಳು) {\latinfont 0.20} ವಿ/ವಿ ({\latinfont 15} ದಿನಗಳು) ಮತ್ತು {\latinfont 0.21} ವಿ/ವಿ ({\latinfont 30} ದಿನಗಳು).\par}
\vspace{8pt}
