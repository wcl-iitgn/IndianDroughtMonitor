...
\newcommand{\idmrunhead}{%
  \begin{minipage}{\textwidth}
    {\small\bfseries\color{titleblue}{\latinfont Runoff Forecast Outlook}}\hfill{\small\color{muted}{\latinfont Forecast initialized June 3, 2026}  ·  {\latinfont valid through Jul 03, 2026}}\\[2pt]
...
\\[3pt]{\small\color{muted}{\latinfont Forecast runoff for the 7-, 15- and 30-day horizons, initialized June 3, 2026}.}\par
\vspace{10pt}
{\large\bfseries\color{titleblue}{\latinfont Outlook}}\\[2pt]
{\justifying\normalsize\color{textblack}ਰਾਸ਼ਟਰੀ ਪੱਧਰ 'ਤੇ ਵਗਣ ਦਾ ਅਨੁਮਾਨ {\latinfont 7} ਦਿਨਾਂ ਲਈ {\latinfont 4.96} ਮਿਲੀਮੀਟਰ {\latinfont 15} ਦਿਨਾਂ ਲਈ {\latinfont 14} ਮਿਲੀਮੀਟਰ ਅਤੇ {\latinfont 30} ਦਿਨਾਂ ਲਈ {\latinfont 40} ਮਿਲੀਮੀਟਰ ਹੈ।\par}
\vspace{8pt}
...
\rowcolor{rowalt} {\latinfont North} & {\latinfont 2.72} & {\latinfont 5.49} & {\latinfont 12}\\
 {\latinfont Northwest} & {\latinfont 0.98} & {\latinfont 2.13} & {\latinfont 6.20}\\
\rowcolor{rowalt} {\latinfont Northeast} & {\latinfont 34} & {\latinfont 103} & {\latinfont 247}\\
 {\latinfont East} & {\latinfont 3.67} & {\latinfont 8.77} & {\latinfont 25}\\
\rowcolor{rowalt} {\latinfont Central} & {\latinfont 1.56} & {\latinfont 3.38} & {\latinfont 12}\\
 {\latinfont West} & {\latinfont 1.26} & {\latinfont 4.57} & {\latinfont 35}\\
\rowcolor{rowalt} {\latinfont South} & {\latinfont 3.86} & {\latinfont 13} & {\latinfont 42}\\
\end{tabular}
\end{document}
